...
namespace WebGLSupport
{
    internal class WebGLInputPlugin
    {
        ...
        [DllImport("__Internal")]
        public static extern int WebGLInputCreate(string canvasId, int x, int y, int width, int height, int fontsize, string text, string placeholder, bool isMultiLine, bool isPassword, bool falseValue, bool isMobile);
        ...
        public static int WebGLInputCreate(string canvasId, int x, int y, int width, int height, int fontsize, string text, string placeholder, bool isMultiLine, bool isPassword, bool falseValue, bool isMobile) { return 0; }
    ...
    public class WebGLInput : MonoBehaviour, IComparable<WebGLInput>
    {
        ...
        RectInt GetElemetRect()
        {
            ...
            {
                */
            return new RectInt((int)(rect.x), (int)(Screen.height - (rect.y)), (int)rect.width, 1);
            // }
        }
        /// <summary>
        /// 対象が選択されたとき
        ...
        public void OnSelect()
        {
            ...
            id = WebGLInputPlugin.WebGLInputCreate(WebGLInput.CanvasId, rect.x, rect.y, rect.width, rect.height, fontSize, input.text, input.placeholder, input.lineType != LineType.SingleLine, isPassword, false, Application.isMobilePlatform);
